...
/**
 * CustomPropertiesJsonhalStorageCustomPropertyShowIdCustomPropertyTimestampableTagTaggingList Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomPropertiesJsonhalStorageCustomPropertyShowIdCustomPropertyTimestampableTagTaggingList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'custom_properties.jsonhal-storageCustomPropertyShow_id_customProperty_timestampable_tagTaggingList';
    ...
    */
    ...
    public function setPropertyName($property_name)
    {
        ...
        if ((!preg_match("/^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/", ObjectSerializer::toString($property_name)))) {
            throw new \InvalidArgumentException("invalid value for \$property_name when calling CustomPropertiesJsonhalStorageCustomPropertyShowIdCustomPropertyTimestampableTagTaggingList., must conform to the pattern /^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/.");
        }
