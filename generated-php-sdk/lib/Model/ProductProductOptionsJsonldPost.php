<?php
/**
 * ProductProductOptionsJsonldPost
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ProductProductOptionsJsonldPost Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductProductOptionsJsonldPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'product_product_options.jsonld-post';
    ...
    protected static $openAPITypes = [
        ...
        'sub_product' => '\OpenAPI\Client\Model\ProductsJsonldPost',
        'option' => '\OpenAPI\Client\Model\ProductOptionsJsonldPost',
        'fees' => 'string',
        'notes' => 'string',
        'slug' => 'string',
        'custom_data' => 'string[]',
    ...
    */
     ...
     * Sets sub_product
     *
     * @param \OpenAPI\Client\Model\ProductsJsonldPost|null $sub_product sub_product
     *
     * @return self
     */
     ...
     * Sets option
     *
     * @param \OpenAPI\Client\Model\ProductOptionsJsonldPost|null $option option
     *
     * @return self
     */
