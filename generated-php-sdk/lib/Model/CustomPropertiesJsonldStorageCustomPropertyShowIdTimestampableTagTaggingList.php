<?php
/**
 * CustomPropertiesJsonldStorageCustomPropertyShowIdTimestampableTagTaggingList
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CustomPropertiesJsonldStorageCustomPropertyShowIdTimestampableTagTaggingList Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomPropertiesJsonldStorageCustomPropertyShowIdTimestampableTagTaggingList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'custom_properties.jsonld-storageCustomPropertyShow_id_timestampable_tagTaggingList';
    ...
    */
    ...
    public function setPropertyName($property_name)
    {
        ...
        if ((!preg_match("/^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/", ObjectSerializer::toString($property_name)))) {
            throw new \InvalidArgumentException("invalid value for \$property_name when calling CustomPropertiesJsonldStorageCustomPropertyShowIdTimestampableTagTaggingList., must conform to the pattern /^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/.");
        }
