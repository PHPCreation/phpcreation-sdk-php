<?php
/**
 * LangsJsonldLangShowIdCustomPropertyTimestampableTagTaggingList
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * LangsJsonldLangShowIdCustomPropertyTimestampableTagTaggingList Class Doc Comment
 *
 * @category Class
 * @description Lang.
 * @package  OpenAPI\Client
 ...
 */
class LangsJsonldLangShowIdCustomPropertyTimestampableTagTaggingList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'langs.jsonld-langShow_id_customProperty_timestampable_tagTaggingList';
    ...
    protected static $openAPITypes = [
        ...
        'tag' => 'string',
        'text' => 'string',
        'language' => '\OpenAPI\Client\Model\LangLanguagesJsonldLangShowIdCustomPropertyTimestampableTagTaggingList',
        'notes' => 'string',
        'shortcode' => 'string',
        'id' => 'int',
        'slug' => 'string',
    ...
    */
     ...
     * Gets language
     *
     * @return \OpenAPI\Client\Model\LangLanguagesJsonldLangShowIdCustomPropertyTimestampableTagTaggingList
     */
     ...
     * Sets language
     *
     * @param \OpenAPI\Client\Model\LangLanguagesJsonldLangShowIdCustomPropertyTimestampableTagTaggingList $language language
     *
     * @return self
     */
