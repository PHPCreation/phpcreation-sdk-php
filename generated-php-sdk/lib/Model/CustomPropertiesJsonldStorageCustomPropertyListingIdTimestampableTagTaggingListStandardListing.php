...
/**
 * CustomPropertiesJsonldStorageCustomPropertyListingIdTimestampableTagTaggingListStandardListing Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomPropertiesJsonldStorageCustomPropertyListingIdTimestampableTagTaggingListStandardListing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'custom_properties.jsonld-storageCustomPropertyListing_id_timestampable_tagTaggingList_standardListing';
    ...
    */
    ...
    public function setPropertyName($property_name)
    {
        ...
        if ((!preg_match("/^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/", ObjectSerializer::toString($property_name)))) {
            throw new \InvalidArgumentException("invalid value for \$property_name when calling CustomPropertiesJsonldStorageCustomPropertyListingIdTimestampableTagTaggingListStandardListing., must conform to the pattern /^([a-zA-Z_\\-$][a-zA-Z_\\-$0-9]*)$/.");
        }
