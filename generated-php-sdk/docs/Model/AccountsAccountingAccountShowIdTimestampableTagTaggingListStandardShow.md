# # AccountsAccountingAccountShowIdTimestampableTagTaggingListStandardShow

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**type** | [**\OpenAPI\Client\Model\AccountTypesAccountingAccountShowIdTimestampableTagTaggingListStandardShow**](AccountTypesAccountingAccountShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**ref** | **string** |  | [optional]
**igrf** | **string** |  | [optional]
**metadata** | **string** |  | [optional]
**is_repertoire** | **bool** |  |
**accepts_transactions** | **bool** |  | [default to true]
**parent** | [**\OpenAPI\Client\Model\AccountsAccountingAccountShowIdTimestampableTagTaggingListStandardShow**](AccountsAccountingAccountShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**children** | [**\OpenAPI\Client\Model\AccountsAccountingAccountShowIdTimestampableTagTaggingListStandardShow[]**](AccountsAccountingAccountShowIdTimestampableTagTaggingListStandardShow.md) | // MUST BE MAPPED IN ENTITY | [optional]
