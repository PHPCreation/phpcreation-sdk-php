...
**sum** | [**FloatInt**](FloatInt.md) | Get the sum of all the account entries with optional start end date parameters. | [optional]
**translations** | [**array<string,UnknownType>**](UnknownType.md) |  | [optional]
**entries** | **string[]** | Get entries. | [optional]
...
**tooltip** | **string** |  | [optional] [readonly]
...
**balance** | **mixed** |  | [optional] [readonly]
**balance_children** | **mixed** |  | [optional] [readonly]
**sum_children** | **mixed** |  | [optional] [readonly]
**dt_balance** | [**\OpenAPI\Client\Model\AccountsDtBalance**](AccountsDtBalance.md) |  | [optional]
**ct_balance** | [**\OpenAPI\Client\Model\AccountsCtBalance**](AccountsCtBalance.md) |  | [optional]
**dt_balance_children** | [**\OpenAPI\Client\Model\AccountsDtBalance**](AccountsDtBalance.md) |  | [optional]
**ct_balance_children** | [**\OpenAPI\Client\Model\AccountsCtBalance**](AccountsCtBalance.md) |  | [optional]
