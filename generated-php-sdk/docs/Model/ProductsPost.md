...
**sectors** | [**\OpenAPI\Client\Model\ProjectSectorsPost[]**](ProjectSectorsPost.md) |  | [optional]
**sku** | **string** |  | [optional]
...
**type** | [**\OpenAPI\Client\Model\ProductTypesPost**](ProductTypesPost.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsPost**](ProductBrandsPost.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersPost**](PersonSuppliersPost.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**product_options** | [**\OpenAPI\Client\Model\ProductProductOptionsPost[]**](ProductProductOptionsPost.md) |  | [optional]
**product_buy_costs** | [**\OpenAPI\Client\Model\ProductProductbuycostsPost[]**](ProductProductbuycostsPost.md) |  | [optional]
**product_sell_prices** | [**\OpenAPI\Client\Model\ProductProductsellpricesPost[]**](ProductProductsellpricesPost.md) |  | [optional]
**sub_product_options** | [**\OpenAPI\Client\Model\ProductProductOptionsPost[]**](ProductProductOptionsPost.md) |  | [optional]
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesPost**](ProductUnitTypesPost.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsPost**](ParameterPeriodsPost.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesPost**](InvoiceLineTypesPost.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesPost**](BillLineTypesPost.md) |  | [optional]
