# # ProductsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty
...
**type** | [**\OpenAPI\Client\Model\ProductTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](ProductTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](ProductBrandsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](PersonSuppliersStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](ProductUnitTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](ParameterPeriodsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](InvoiceLineTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](BillLineTypesStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
**on_distribution** | **bool** |  | [default to true]
**on_website** | **bool** |  | [default to true]
**owning_corporation** | [**\OpenAPI\Client\Model\PersonCorporationsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty**](PersonCorporationsStandardShowProductShowNoteShowIdTimestampableTagTaggingListNoteRelationsCustomProperty.md) |  | [optional]
