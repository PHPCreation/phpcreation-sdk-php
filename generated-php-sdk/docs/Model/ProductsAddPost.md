...
**sectors** | [**\OpenAPI\Client\Model\ProjectSectorsAddPost[]**](ProjectSectorsAddPost.md) |  | [optional]
**sku** | **string** |  | [optional]
...
**type** | [**\OpenAPI\Client\Model\ProductTypesAddPost**](ProductTypesAddPost.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsAddPost**](ProductBrandsAddPost.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersAddPost**](PersonSuppliersAddPost.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**product_options** | [**\OpenAPI\Client\Model\ProductProductOptionsAddPost[]**](ProductProductOptionsAddPost.md) |  | [optional]
**product_buy_costs** | [**\OpenAPI\Client\Model\ProductProductbuycostsAddPost[]**](ProductProductbuycostsAddPost.md) |  | [optional]
**product_sell_prices** | [**\OpenAPI\Client\Model\ProductProductsellpricesAddPost[]**](ProductProductsellpricesAddPost.md) |  | [optional]
**sub_product_options** | [**\OpenAPI\Client\Model\ProductProductOptionsAddPost[]**](ProductProductOptionsAddPost.md) |  | [optional]
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesAddPost**](ProductUnitTypesAddPost.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsAddPost**](ParameterPeriodsAddPost.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesAddPost**](InvoiceLineTypesAddPost.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesAddPost**](BillLineTypesAddPost.md) |  | [optional]
