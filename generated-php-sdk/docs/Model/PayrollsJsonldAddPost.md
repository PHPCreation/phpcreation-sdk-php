# # PayrollsJsonldAddPost

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**cumulative_t4** | [**\OpenAPI\Client\Model\PayrollT4sJsonldAddPost**](PayrollT4sJsonldAddPost.md) |  | [optional]
**timesheet_date_start** | **\DateTime** |  |
**timesheet_date_end** | **\DateTime** |  |
**status** | [**\OpenAPI\Client\Model\PayrollStatusesJsonldAddPost**](PayrollStatusesJsonldAddPost.md) | Get status. |
**created_date** | **\DateTime** |  |
**employee** | [**\OpenAPI\Client\Model\PersonEmployeesJsonldAddPost**](PersonEmployeesJsonldAddPost.md) | Get employesId. |
**nb_hours** | **string** |  |
...
**net_salary** | **string** |  |
**bonis** | [**\OpenAPI\Client\Model\TimesheetBonisJsonldAddPost[]**](TimesheetBonisJsonldAddPost.md) |  | [optional]
**timesheets** | [**\OpenAPI\Client\Model\TimesheetsJsonldAddPost[]**](TimesheetsJsonldAddPost.md) |  | [optional]
**notes** | **string** |  | [optional]
**vacancy_boni** | [**\OpenAPI\Client\Model\TimesheetBonisJsonldAddPost**](TimesheetBonisJsonldAddPost.md) |  | [optional]
