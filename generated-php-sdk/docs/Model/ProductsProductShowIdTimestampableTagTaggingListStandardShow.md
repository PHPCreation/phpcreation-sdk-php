# # ProductsProductShowIdTimestampableTagTaggingListStandardShow
...
**type** | [**\OpenAPI\Client\Model\ProductTypesProductShowIdTimestampableTagTaggingListStandardShow**](ProductTypesProductShowIdTimestampableTagTaggingListStandardShow.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsProductShowIdTimestampableTagTaggingListStandardShow**](ProductBrandsProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersProductShowIdTimestampableTagTaggingListStandardShow**](PersonSuppliersProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesProductShowIdTimestampableTagTaggingListStandardShow**](ProductUnitTypesProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsProductShowIdTimestampableTagTaggingListStandardShow**](ParameterPeriodsProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesProductShowIdTimestampableTagTaggingListStandardShow**](InvoiceLineTypesProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesProductShowIdTimestampableTagTaggingListStandardShow**](BillLineTypesProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**on_distribution** | **bool** |  | [default to true]
**on_website** | **bool** |  | [default to true]
**owning_corporation** | [**\OpenAPI\Client\Model\PersonCorporationsProductShowIdTimestampableTagTaggingListStandardShow**](PersonCorporationsProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
