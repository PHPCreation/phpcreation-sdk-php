...
**cumulative_t4** | [**\OpenAPI\Client\Model\PayrollT4sJsonhalAddPost**](PayrollT4sJsonhalAddPost.md) |  | [optional]
**timesheet_date_start** | **\DateTime** |  |
**timesheet_date_end** | **\DateTime** |  |
**status** | [**\OpenAPI\Client\Model\PayrollStatusesJsonhalAddPost**](PayrollStatusesJsonhalAddPost.md) | Get status. |
...
**net_salary** | **string** |  |
**bonis** | [**\OpenAPI\Client\Model\TimesheetBonisJsonhalAddPost[]**](TimesheetBonisJsonhalAddPost.md) |  | [optional]
**timesheets** | [**\OpenAPI\Client\Model\TimesheetsJsonhalAddPost[]**](TimesheetsJsonhalAddPost.md) |  | [optional]
**notes** | **string** |  | [optional]
**vacancy_boni** | [**\OpenAPI\Client\Model\TimesheetBonisJsonhalAddPost**](TimesheetBonisJsonhalAddPost.md) |  | [optional]
