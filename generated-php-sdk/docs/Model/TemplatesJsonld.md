...
**data_processor** | **string** | DataProcessor to be loaded when the Template is loaded (Loaded for an entity Print or some specific render) In other cases, a widget MUST be used, this is really for use cases that has no widgets. | [optional]
