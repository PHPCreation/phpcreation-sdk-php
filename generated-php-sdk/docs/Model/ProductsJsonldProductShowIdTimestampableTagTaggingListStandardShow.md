...
**type** | [**\OpenAPI\Client\Model\ProductTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow**](ProductTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsJsonldProductShowIdTimestampableTagTaggingListStandardShow**](ProductBrandsJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersJsonldProductShowIdTimestampableTagTaggingListStandardShow**](PersonSuppliersJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow**](ProductUnitTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsJsonldProductShowIdTimestampableTagTaggingListStandardShow**](ParameterPeriodsJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow**](InvoiceLineTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow**](BillLineTypesJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**on_distribution** | **bool** |  | [default to true]
**on_website** | **bool** |  | [default to true]
**owning_corporation** | [**\OpenAPI\Client\Model\PersonCorporationsJsonldProductShowIdTimestampableTagTaggingListStandardShow**](PersonCorporationsJsonldProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
