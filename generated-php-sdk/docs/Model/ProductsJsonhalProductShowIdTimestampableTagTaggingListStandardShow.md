# # ProductsJsonhalProductShowIdTimestampableTagTaggingListStandardShow
...
**type** | [**\OpenAPI\Client\Model\ProductTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](ProductTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  |
**brand** | [**\OpenAPI\Client\Model\ProductBrandsJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](ProductBrandsJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**supplier** | [**\OpenAPI\Client\Model\PersonSuppliersJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](PersonSuppliersJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**weight** | **string** |  |
**dimension_w** | **string** |  |
**dimension_h** | **string** |  |
**dimension_d** | **string** |  |
...
**unit_type** | [**\OpenAPI\Client\Model\ProductUnitTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](ProductUnitTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**unit_nb** | **string** |  | [optional] [default to '1']
**supplier_code** | **string** |  | [optional]
**client_code** | **string** |  | [optional]
**sh_code** | **string** |  | [optional]
**reservation_periodicity** | [**\OpenAPI\Client\Model\ParameterPeriodsJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](ParameterPeriodsJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**periodicity_precision** | **string** |  |
**bookable** | **bool** |  | [default to true]
**discountable** | **bool** |  | [default to true]
**salable** | **bool** |  | [default to true]
**invoice_line_type** | [**\OpenAPI\Client\Model\InvoiceLineTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](InvoiceLineTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**purchasable** | **bool** |  | [default to true]
**bill_line_type** | [**\OpenAPI\Client\Model\BillLineTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](BillLineTypesJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
**on_distribution** | **bool** |  | [default to true]
**on_website** | **bool** |  | [default to true]
**owning_corporation** | [**\OpenAPI\Client\Model\PersonCorporationsJsonhalProductShowIdTimestampableTagTaggingListStandardShow**](PersonCorporationsJsonhalProductShowIdTimestampableTagTaggingListStandardShow.md) |  | [optional]
